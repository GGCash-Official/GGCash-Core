Contributing to GGCash Core
============================

The GGCash Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ggcash-project/ggcash/blob/master/doc/translation_process.md)
...
The following applies to code changes to the GGCash Core project, and is not to be
confused with overall GGCash Network Protocol consensus changes.

Whether a pull request is merged into GGCash Core rests with the project merge
...
Patches that change GGCash consensus rules are considerably more involved than
...
Where a patchset proposes to change the GGCash consensus, it must have been
...
The project leader is the release manager for each GGCash Core release.
