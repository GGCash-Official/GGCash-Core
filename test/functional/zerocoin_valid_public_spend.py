...
from fake_stake.base_test import GGCash_FakeStakeTest

class zGGHValidCoinSpendTest(GGCash_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zGGHs..." % DENOM_TO_USE)
