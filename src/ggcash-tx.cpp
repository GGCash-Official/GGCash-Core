...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GGCash Core ggcash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ggcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ggcash transaction") + "\n" +
                               "  ggcash-tx [options] -create [commands]   " + _("Create hex-encoded ggcash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ggcash transaction
