...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::GGH);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeGGCashAmount"))
        SoftSetArg("-anonymizeggcashamount", settings.value("nAnonymizeGGCashAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in ggcash.cpp during shotdown to also remove the window positions
