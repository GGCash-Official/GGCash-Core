                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzGGHPathCustom = GetArg("-zgghbackuppath", "");
    ...
    if(!strzGGHPathCustom.empty()) {
        ui->wallet_customzgghbackuppath->setText(QString::fromStdString(strzGGHPathCustom));
        ui->wallet_customzgghbackuppath_label->setVisible(true);
        ui->wallet_customzgghbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzGGHPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the GGCash RPC console.") + "<br>" +
