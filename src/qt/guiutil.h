...
/** Utility functions used by the GGCash Qt UI.
 */
namespace GUIUtil
{
...
// Render GGCash addresses in monospace font
...
// Parse "ggcash:" URI into recipient object, return true on successful parsing
