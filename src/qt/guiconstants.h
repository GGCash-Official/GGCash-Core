...
/* GGCash GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "GGCash"
#define QAPP_ORG_DOMAIN "ggcash.org"
#define QAPP_APP_NAME_DEFAULT "GGCash-Qt"
#define QAPP_APP_NAME_TESTNET "GGCash-Qt-testnet"
