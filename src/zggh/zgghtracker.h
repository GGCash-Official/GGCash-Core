...
#ifndef GGCash_ZGGHTRACKER_H
#define GGCash_ZGGHTRACKER_H
...
public:
    CzGGHTracker(std::string strWalletFile);
    ~CzGGHTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzGGHWallet* zGGHWallet = NULL);
