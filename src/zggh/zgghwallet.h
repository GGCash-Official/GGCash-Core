...
#ifndef GGCash_ZGGHWALLET_H
#define GGCash_ZGGHWALLET_H
...
public:
    CzGGHWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZGGH(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZGGH(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
