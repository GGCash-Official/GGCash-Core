...
extern UniValue DoZgghSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzgghseed(const UniValue& params, bool fHelp);
extern UniValue getzgghseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzggh(const UniValue& params, bool fHelp);
extern UniValue dzgghstate(const UniValue& params, bool fHelp);
