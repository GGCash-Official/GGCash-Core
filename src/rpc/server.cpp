...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GGCash features */
        {"ggcash", "listmasternodes", &listmasternodes, true, true, false},
        {"ggcash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ggcash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ggcash", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ggcash", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ggcash", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ggcash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ggcash", "masternodedebug", &masternodedebug, true, true, false},
        {"ggcash", "startmasternode", &startmasternode, true, true, false},
        {"ggcash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ggcash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ggcash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ggcash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ggcash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ggcash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ggcash", "preparebudget", &preparebudget, true, true, false},
        {"ggcash", "submitbudget", &submitbudget, true, true, false},
        {"ggcash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ggcash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ggcash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ggcash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ggcash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ggcash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ggcash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ggcash", "checkbudgets", &checkbudgets, true, true, false},
        {"ggcash", "mnsync", &mnsync, true, true, false},
        {"ggcash", "spork", &spork, true, true, false},
        {"ggcash", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzgghseed", &getzgghseed, false, false, true},
        {"zerocoin", "setzgghseed", &setzgghseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzggh", &searchdzggh, false, false, true},
        {"zerocoin", "dzgghstate", &dzgghstate, false, false, true},
...
{
    return "> ggcash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:24483/\n";
}
